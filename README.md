...
«Nota: La estructura anterior representa la organización propuesta del proyecto. Los nombres de clases y paquetes deben coincidir exactamente con los que se encuentren implementados en el repositorio final.»
...
El proyecto incluye documentación complementaria relacionada con el diseño y funcionamiento del sistema.

Entre los archivos entregados se encuentran:

- Código fuente del proyecto.
- "database.sql" con la estructura de la base de datos.
- Diagrama entidad-relación.
- "README.md" con información general del proyecto.
- Reportes generados en formato PDF, según las funcionalidades implementadas.
